...
export function mergeOptions(opt1, opt2) {
    const s1 = (opt1 === null || opt1 === void 0 ? void 0 : opt1.style) || {};
    const s2 = (opt2 === null || opt2 === void 0 ? void 0 : opt2.style) || {};
    return Object.assign({}, opt1, opt2, {
        style: (opt1 === null || opt1 === void 0 ? void 0 : opt1.style) ? Object.assign({}, s1, s2) : s2,
    });
}
/**
 * <zh/> 获取图形子图形样式
