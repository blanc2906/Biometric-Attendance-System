...
class BaseEdge extends base_element_1.BaseElement {
    ...
    drawArrow(attributes, type) {
        ...
        if (enable) {
            ...
            if (!(0, effect_1.effect)(this, `arrow-${type}`, arrowStyle))
                return;
    ...
    drawLabelShape(attributes, container) {
        ...
        if (!(0, effect_1.effect)(this, 'label', style))
            return;
    ...
    drawKeyShape(attributes, container) {
        ...
        if (!(0, effect_1.effect)(this, 'key', style))
            return;
